window.onload = function() {
  ...
  var FortyFiveSecs = document.getElementById('fortyFiveSecs');
 
  var SixtySecs=document.getElementById('sixtySecs');
  ...
  ThirtySeconds.onclick = function() {
   ...
   fortyFiveSecs.onclick = function() {

   	  var timeAdd = setInterval(countFortyFiveSecs,1000);
   };

   
   SixtySecs.onclick = function() {

    var timeAdd = setInterval(countSixtySecsSecs,1000);
  };

  
  FiveMins.onclick = function() {
  ...
  function countFortyFiveSecs() {
		   ...
		   {
        Timer.innerHTML = "00:"+parseInt(timeLeft,15)+":0"+tenths;
        timeLeft--;
        }
  }
   ...
   function countSixtySecsSecs() {
		   ...
		   {
        Timer.innerHTML = "00:"+parseInt(timeLeft,20)+":0"+tenths;
        timeLeft--;
        }
  }
