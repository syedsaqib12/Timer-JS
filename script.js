window.onload = function() {
  ...
  var FiveMins = this.document.getElementById('five')
  var time = 0;
  var running = 0;
  var timeLeft = 30;
  ...
  ThirtySeconds.onclick = function() {
   ...
   thirtyMins.onclick = function() {
   	  ...
   	  var timeAdd=setInterval(countBeginsOne,1000);
   };
  ...
  */
  ...
  function countBeginsOne() {	 
    ...
    tenths = time % 10;
     ...
     {
   Timer.innerHTML = parseInt(timeLeft,20) +parseInt(timeLeft,20)+":0"+tenths;
   timeLeft--;
     }
}
